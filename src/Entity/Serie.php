...
class Serie
{
    ...
    #[Assert\NotBlank(message: "Please provid a nam for the serie !")]
    #[Assert\Length(min: 2, max: 255, minMessage: "Minimum 2 characters", maxMessage: 'Maximum 255 characters please')]
    private ?string $name = null;

    #[ORM\Column(type: Types::TEXT, nullable: true)]
    #[Assert\Length(max: 3000, minMessage: "Minimum 10 characters", maxMessage: 'Maximum 255 characters please')]
    ...
    #[Assert\GreaterThanOrEqual(propertyPath: 'firstAirDate', message: "This date must be greater than first air date")]
    private ?\DateTimeInterface $firstAirDate = null;

    #[ORM\Column(type: Types::DATE_MUTABLE)]
    #[Assert\NotBlank(message: "Please provide a date !")]
    #[Assert\LessThanOrEqual(propertyPath: 'firstAirDate', message: "This date must be greater than first last date")]
